...
def run_scousepy():
    ...
    outputdir = '../output/refined_grid_example/'
    ...
    if os.path.exists(datadirectory+filename+'/stage_1/s1.scousepy'):
        ...
        s = scouse.stage_1(filename, datadirectory, wsaa, ppv_vol=ppv_vol, outputdir=outputdir, mask_below=mask, refine_grid=refine_grid, nrefine=number_of_refinements, fittype=fittype, verbose = verb, write_moments=True, save_fig=True)
